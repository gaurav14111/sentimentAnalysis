...
1. Clone the repository and navigate to the downloaded folder.
	```
		git clone https://github.com/SmirnovaAlina/Sentiment_analysis_NLP_ML.git
	```
...
for the project.
- [Amazon SageMaker](https://us-west-2.console.aws.amazon.com/sagemaker/home?region=us-west-2#/notebook-instances) (Build, train, and deploy a model)
